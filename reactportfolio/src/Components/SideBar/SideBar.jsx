...
const SideBar = () => {
    ...
    return (  
        ...
        <a href="https://drive.google.com/open?id=1Yak5SmIttBbPpqWAKa0-CffC6G-TtH1Q" target="__blank" className="resume" data-toggle="tooltip" data-placement="top" title="Resume"><i className="far fa-file"></i></a>
        </div>
